...
export class AuthService {
  ...
  public static readonly forgotPassword = async (data: ForgotPasswordRequestDto) => 
      post<ForgotPasswordResponseDto>(`${this.base}/forgot-password`, data);

  public static readonly refresh = async () => post<RefreshResponseDto>(`${this.base}/refresh`);

  public static readonly logout = async () => post<LogoutResponseDto>(`${this.base}/logout`)
}
